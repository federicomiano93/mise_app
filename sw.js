const CACHE_NAME = 'theitalianclub-v362';
...
// small — activate() only happens after a successful 250-file precache, i.e.
...
// project's post-deploy sweep, which already asks the live site for all 250 files.
