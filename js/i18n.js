...
const DICTIONARIES = Object.freeze({
  en: Object.freeze({
    ...
    'orders.addSupplierInline': '+ New supplier',
    ...
    'cat.recipe': 'Recipe',
    'cat.fc.title': 'Food cost',
    'cat.fc.note': 'What this recipe costs is worked out in Food cost, with the oven loss and everything else that goes into the product.',
    'cat.fc.open': 'Open in Food cost',
    'cat.suggest.label': 'Catalogue ingredients to link',
    'cat.suggest.seeAll': 'See all ({n})',
    'cat.createIngredient': '+ Add «{name}» as an ingredient',
    'fc.checkNumber': 'Check «{field}»: that number cannot be saved (it must be more than 0, and not too large).',
    'fc.settings.rateOutOfRange': 'The hourly cost must be more than 0 and at most 10,000. Leave it empty to remove it.',
    'orders.eg.phone': 'e.g. 447700900123',
    'cat.suggest.linked': 'linked',
    ...
    'fc.addAtLeastOne': 'Add at least one recipe or ingredient to this product',
    'fc.chooseWhetherThisIs': 'Choose whether this is sold by the piece, by weight or by the pack',
    ...
    'fc.productionCost': 'Production cost',
    'fc.wholeBatch': 'Whole batch: {cost}',
    'fc.wholeBatchWord': 'whole batch',
    'fc.costPartial': 'Part of this product is not priced yet, so it really costs more than this.',
    'fc.thisRecipePartlyPriced': 'Only part of this recipe has a price',
    'fc.suggestedPrice': 'Suggested price',
    'fc.suggestedPriceBasis': 'With VAT at {vat}%, for a {target}% food cost.',
    'fc.suggestedPriceNeeds': 'Choose the VAT rate and a food cost target to see the price to sell it at.',
    'fc.suggestedPricePartial': 'Part of this product is not priced yet, so the right price is higher than this.',
    'fc.suggestedPriceInUse': 'This is the selling price.',
    'fc.useThisPrice': 'Use this price',
    'fc.vatGuide.open': 'Which products take which VAT rate',
    'fc.vatGuide.title': 'VAT rates',
    'fc.vatGuide.disclaimer': 'A guide to the commonest cases in the law. Which rate applies to your product is for your accountant to confirm.',
    'fc.vatGuide.rate': 'VAT {rate}%',
    'fc.vatGuide.use': 'Use {rate}%',
    'fc.vatGuide.inUse': 'In use',
    'fc.vatGuide.notes': 'Good to know',
    'fc.vatGuide.sources': 'Sources, checked on {date}:',
    // ── What a product is made of, and how it is sold (13 Sep 2026) ──
    'fc.addRecipeOrIngredient': '+ Add recipe or ingredient',
    'fc.pickRecipe': 'Choose a recipe',
    'fc.pickRecipeOrIngredient': 'Add to the product',
    'fc.pickIngredient': 'Choose an ingredient',
    'fc.pickPackaging': 'Choose packaging',
    'fc.searchPick': 'Search…',
    'fc.ingredients': 'Ingredients',
    'fc.nothingMatches': 'Nothing matches your search.',
    'fc.noRecipesYet': 'No recipes yet — add them in the Recipe book.',
    'fc.noPackagingYet': 'No packaging yet — add it in Suppliers and ingredients, under Packaging.',
    'fc.openRegistry': 'Open Suppliers and ingredients',
    'fc.recipeWord': 'Recipe',
    'fc.suggest.label': 'Recipes to base this product on',
    'fc.recipeAlreadyUsed': {
      one: '“{name}” is already in another product.',
      other: '“{name}” is already in {n} products.',
    },
    'fc.aria.ingredient': 'Ingredient',
    'fc.aria.quantity': 'Quantity',
    'fc.aria.unit': 'Unit',
    'fc.aria.changeLine': 'Change: {name}',
    'fc.removeIngredient': 'Remove ingredient',
    'fc.unit.pieces': 'pieces',
    'fc.ingredientNoPrice': 'This ingredient has no price yet',
    'fc.ingredientNoPieceWeight': 'Bought by the piece — say what one piece weighs in Suppliers and ingredients, or count it in pieces',
    'fc.ingredientNoPiecePrice': 'Bought by weight — say what one piece weighs in Suppliers and ingredients, or count it in grams',
    'fc.weighFor': 'Dough for «{name}»',
    'fc.byThePack': 'By the pack',
    'fc.packHolds': 'One pack holds',
    'fc.packHoldsAs': 'What one pack holds',
    'fc.packHoldsNote': 'The weight in one pack, or how many pieces.',
    'fc.sayWhatAPackHolds': 'Say what one pack holds',
    'fc.perPack': 'per pack',
    'fc.packagingPer.piece': 'per piece',
    'fc.packagingPer.pack': 'per pack',
    ...
    'fc.labourPeople': 'People working on it',
    'fc.labourNote': 'The time it takes to make one batch, from weighing to the finished product. Left empty, labour is not counted.',
    'fc.labourSetRate': 'Set the hourly labour cost in Settings to see what the work costs.',
    'fc.costSplit': '{materials} ingredients and packaging  ·  {labour} labour',
    'fc.costTotal': 'With labour: {total} {unit}',
    'fc.labourPctLine': 'Labour {labour}%  ·  everything {total}% of the net price',
    'fc.settings.title': 'Food cost settings',
    'fc.settings.labourRate': 'Labour cost per hour ({currency})',
    'fc.settings.labourRateAs': 'Labour cost per hour',
    'fc.settings.labourRateNote': 'What one hour of one person’s work costs the business, contributions included. Only owners and managers see it.',
    'fc.settings.saveQ': 'Save the hourly labour cost?',
    'fc.settings.saved': 'Hourly labour cost saved.',
    'fc.settings.couldNotSave': 'The hourly labour cost was not saved — only an owner or a manager can change it.',
    // ── Packaging in Suppliers and ingredients (13 Sep 2026) ──
    'orders.tab.packaging': 'Packaging',
    'orders.addPackaging': '+ Add packaging',
    'orders.noPackagingYet': 'No packaging yet. Add the boxes, bags and labels you buy, so Food cost can count them.',
    'orders.noPackagingMatches': 'No packaging matches your search.',
    'orders.searchPackaging': 'Search packaging',
    'orders.field.kind': 'Type',
    'orders.kind.ingredient': 'Ingredient',
    'orders.kind.packaging': 'Packaging',
    'orders.newPackaging': 'New packaging',
    'orders.editPackaging': 'Edit packaging',
    'orders.packagingTag': 'Packaging',
    'fc.packagingPerNote': 'Boxes, bags, labels — how many for each piece, pack or kilo you sell. They add cost but no weight.',
    'fc.listCost': '{cost} cost',
    'fc.listMargin': '{margin} margin',
    'fc.productsWithRecipe': 'Products with “{name}”',
    'fc.productsWithThisRecipe': 'Products with this recipe',
    'fc.showAll': 'Show all',
    ...
    'homeCards.show.title': 'Show «{card}» to employees?',
    'homeCards.show.foodcost': 'They will see what every ingredient costs, what each product costs to make and its margin, and they will be able to change them. Deleting stays with owners and managers.',
    'homeCards.show.inventory': 'They will see the products and be able to type the counts. They will not see any price or value, and closing or reopening a month stays with owners and managers.',
    'homeCards.show.ok': 'Show it',
  ...
  it: Object.freeze({
    ...
    'orders.addSupplierInline': '+ Nuovo fornitore',
    ...
    'cat.recipe': 'Ricetta',
    'cat.fc.title': 'Food cost',
    'cat.fc.note': 'Quanto costa questa ricetta si calcola nel Food cost, con il calo peso e tutto quello che entra nel prodotto.',
    'cat.fc.open': 'Apri nel Food cost',
    'cat.suggest.label': 'Ingredienti del catalogo da collegare',
    'cat.suggest.seeAll': 'Vedi tutti ({n})',
    'cat.createIngredient': '+ Crea «{name}» come ingrediente',
    'fc.checkNumber': 'Controlla «{field}»: questo numero non si può salvare (deve essere maggiore di 0, e non troppo grande).',
    'fc.settings.rateOutOfRange': 'Il costo orario deve essere maggiore di 0 e al massimo 10.000. Lascialo vuoto per toglierlo.',
    'orders.eg.phone': 'es. 393331234567',
    'cat.suggest.linked': 'collegato',
    ...
    'fc.addAtLeastOne': 'Aggiungi almeno una ricetta o un ingrediente a questo prodotto',
    'fc.chooseWhetherThisIs': 'Scegli se si vende al pezzo, a peso o a confezione',
    ...
    'fc.productionCost': 'Costo di produzione',
    'fc.wholeBatch': 'Infornata intera: {cost}',
    'fc.wholeBatchWord': 'infornata intera',
    'fc.costPartial': 'Una parte di questo prodotto non ha ancora un prezzo, quindi costa davvero più di così.',
    'fc.thisRecipePartlyPriced': 'Solo una parte di questa ricetta ha un prezzo',
    'fc.suggestedPrice': 'Prezzo consigliato',
    'fc.suggestedPriceBasis': 'Con IVA al {vat}%, per un food cost del {target}%.',
    'fc.suggestedPriceNeeds': 'Scegli l’aliquota IVA e un obiettivo di food cost per vedere a quanto venderlo.',
    'fc.suggestedPricePartial': 'Una parte di questo prodotto non ha ancora un prezzo, quindi il prezzo giusto è più alto di così.',
    'fc.suggestedPriceInUse': 'È il prezzo di vendita.',
    'fc.useThisPrice': 'Usa questo prezzo',
    'fc.vatGuide.open': 'Quali prodotti hanno quale aliquota IVA',
    'fc.vatGuide.title': 'Aliquote IVA',
    'fc.vatGuide.disclaimer': 'Una guida ai casi più comuni previsti dalla legge. Quale aliquota vale per il tuo prodotto lo conferma il commercialista.',
    'fc.vatGuide.rate': 'IVA {rate}%',
    'fc.vatGuide.use': 'Usa {rate}%',
    'fc.vatGuide.inUse': 'In uso',
    'fc.vatGuide.notes': 'Da sapere',
    'fc.vatGuide.sources': 'Fonti, verificate il {date}:',
    // ── Di che cosa è fatto un prodotto, e come si vende (13 set 2026) ──
    'fc.addRecipeOrIngredient': '+ Aggiungi ricetta o ingrediente',
    'fc.pickRecipe': 'Scegli una ricetta',
    'fc.pickRecipeOrIngredient': 'Aggiungi al prodotto',
    'fc.pickIngredient': 'Scegli un ingrediente',
    'fc.pickPackaging': 'Scegli un imballaggio',
    'fc.searchPick': 'Cerca…',
    'fc.ingredients': 'Ingredienti',
    'fc.nothingMatches': 'Niente corrisponde alla ricerca.',
    'fc.noRecipesYet': 'Ancora nessuna ricetta — aggiungile nel Ricettario.',
    'fc.noPackagingYet': 'Ancora nessun imballaggio — aggiungili in Fornitori e ingredienti, sotto Imballaggi.',
    'fc.openRegistry': 'Apri Fornitori e ingredienti',
    'fc.recipeWord': 'Ricetta',
    'fc.suggest.label': 'Ricette su cui basare questo prodotto',
    'fc.recipeAlreadyUsed': {
      one: '«{name}» è già in un altro prodotto.',
      other: '«{name}» è già in {n} prodotti.',
    },
    'fc.aria.ingredient': 'Ingrediente',
    'fc.aria.quantity': 'Quantità',
    'fc.aria.unit': 'Unità',
    'fc.aria.changeLine': 'Cambia: {name}',
    'fc.removeIngredient': 'Togli l’ingrediente',
    'fc.unit.pieces': 'pezzi',
    'fc.ingredientNoPrice': 'Questo ingrediente non ha ancora un prezzo',
    'fc.ingredientNoPieceWeight': 'Si compra a pezzo — scrivi quanto pesa un pezzo in Fornitori e ingredienti, oppure contalo in pezzi',
    'fc.ingredientNoPiecePrice': 'Si compra a peso — scrivi quanto pesa un pezzo in Fornitori e ingredienti, oppure contalo in grammi',
    'fc.weighFor': 'Impasto di «{name}»',
    'fc.byThePack': 'A confezione',
    'fc.packHolds': 'Una confezione contiene',
    'fc.packHoldsAs': 'Quanto contiene una confezione',
    'fc.packHoldsNote': 'Il peso di una confezione, oppure quanti pezzi.',
    'fc.sayWhatAPackHolds': 'Indica quanto contiene una confezione',
    'fc.perPack': 'a confezione',
    'fc.packagingPer.piece': 'per pezzo',
    'fc.packagingPer.pack': 'per confezione',
    'fc.packagingPer.kg': 'per kg',
    ...
    'fc.labourPeople': 'Persone al lavoro',
    'fc.labourNote': 'Il tempo per fare un’infornata, dalla pesata al prodotto finito. Se lo lasci vuoto, il lavoro non viene contato.',
    'fc.labourSetRate': 'Imposta il costo orario del lavoro nelle Impostazioni per vedere quanto costa il lavoro.',
    'fc.costSplit': '{materials} ingredienti e imballaggi  ·  {labour} lavoro',
    'fc.costTotal': 'Con il lavoro: {total} {unit}',
    'fc.labourPctLine': 'Lavoro {labour}%  ·  tutto {total}% del prezzo netto',
    'fc.settings.title': 'Impostazioni del Food cost',
    'fc.settings.labourRate': 'Costo del lavoro all’ora ({currency})',
    'fc.settings.labourRateAs': 'Costo del lavoro all’ora',
    'fc.settings.labourRateNote': 'Quanto costa all’azienda un’ora di lavoro di una persona, contributi compresi. Lo vedono solo titolari e responsabili.',
    'fc.settings.saveQ': 'Vuoi salvare il costo orario del lavoro?',
    'fc.settings.saved': 'Costo orario del lavoro salvato.',
    'fc.settings.couldNotSave': 'Il costo orario del lavoro non è stato salvato — può cambiarlo solo un titolare o un responsabile.',
    // ── Imballaggi in Fornitori e ingredienti (13 set 2026) ──
    'orders.tab.packaging': 'Imballaggi',
    'orders.addPackaging': '+ Aggiungi imballaggio',
    'orders.noPackagingYet': 'Ancora nessun imballaggio. Aggiungi le scatole, i sacchetti e le etichette che compri, così il Food cost li può contare.',
    'orders.noPackagingMatches': 'Nessun imballaggio corrisponde alla ricerca.',
    'orders.searchPackaging': 'Cerca un imballaggio',
    'orders.field.kind': 'Tipo',
    'orders.kind.ingredient': 'Ingrediente',
    'orders.kind.packaging': 'Imballaggio',
    'orders.newPackaging': 'Nuovo imballaggio',
    'orders.editPackaging': 'Modifica imballaggio',
    'orders.packagingTag': 'Imballaggio',
    'fc.packagingPerNote': 'Scatole, sacchetti, etichette — quanti per ogni pezzo, confezione o chilo che vendi. Aggiungono costo ma non peso.',
    'fc.listCost': '{cost} di costo',
    'fc.listMargin': '{margin} di margine',
    'fc.productsWithRecipe': 'Prodotti con «{name}»',
    'fc.productsWithThisRecipe': 'Prodotti con questa ricetta',
    'fc.showAll': 'Mostra tutti',
    ...
    'homeCards.show.title': 'Mostrare «{card}» ai dipendenti?',
    'homeCards.show.foodcost': 'Vedranno quanto costa ogni ingrediente, quanto costa fare ogni prodotto e il suo margine, e potranno modificarli. Eliminare resta a titolare e manager.',
    'homeCards.show.inventory': 'Vedranno i prodotti e potranno inserire i conteggi. Non vedranno prezzi né valori, e chiudere o riaprire un mese resta a titolare e manager.',
    'homeCards.show.ok': 'Mostra',
