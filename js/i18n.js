...
const DICTIONARIES = Object.freeze({
  en: Object.freeze({
    ...
    // ── Stocktake — the end-of-month count ───────────────────────────
    // ⚠️ THE ONE SENTENCE THIS SCREEN CANNOT DO WITHOUT is inv.emptyIsNotZero. An
    // empty box means "nobody has counted this yet", never zero, and every number
    // on the screen depends on the person reading it knowing that.
    'inv.monthOpen': 'Open',
    'inv.monthClosed': 'Closed',
    'inv.previousMonth': 'The month before',
    'inv.nextMonth': 'The month after',
    'inv.counted': 'Counted',
    'inv.countedOf': '{counted} of {total}',
    'inv.emptyIsNotZero': 'A box left empty means “not counted yet”, never zero.',
    'inv.monthClosedNote': 'This month is closed: its figures no longer change.',
    'inv.searchProducts': 'Search a product',
    'inv.stillToCount': 'Still to count',
    'inv.nothingMatches': 'Nothing matches.',
    'inv.noProductsYet': 'No products yet. They come from Suppliers & ingredients.',
    'inv.noCategory': 'No category',
    'inv.unnamedProduct': 'Product with no name',
    'inv.packsShort': 'packs',
    'inv.notCountedYet': 'Not counted yet',
    'inv.noOpeningYet': 'No opening figure yet',
    'inv.hadBoughtUsed': 'Had {had} · bought {bought} · used {used}',
    'inv.countFor': 'How many of {name} are left',
    'inv.openProduct': 'Open {name}',
    'inv.usedThisMonth': 'Used this month',
    'inv.answerNeedsCount': 'Count what is left and this answers itself.',
    'inv.answerNeedsOpening': 'Say how many there were when the month opened and this answers itself.',
    'inv.hadBoughtLeft': 'Had {had} · bought {bought} · left {left}',
    'inv.moreThanPossible': 'There is more here than you started with plus everything you bought. One of the three numbers is wrong.',
    'inv.openingCount': 'How many there were when the month opened',
    'inv.openingHint': 'Written once. From next month the app carries it forward from what was left.',
    'inv.purchasedCount': 'How many you bought during the month',
    'inv.purchasedHint': 'Left empty it counts as none bought.',
    'inv.closingCount': 'How many there are now',
    'inv.closingHint': 'Half a pack is 0.5.',
    'inv.onePackIs': 'One pack is {pack}.',
    'inv.carryShort': 'Carry forward',
    'inv.purchasesShort': 'From the orders',
    'inv.seeCost': 'What it cost',
    'inv.costTitle': 'What the month cost',
    'inv.costThisMonth': 'Cost of what was used',
    'inv.costBasis': { one: 'Worked out from {counted} product you counted.', other: 'Worked out from {counted} products you counted.' },
    'inv.costBasisPartial': { one: 'Worked out from {counted} counted, of which {n} has no value yet.', other: 'Worked out from {counted} counted, of which {n} have no value yet.' },
    'inv.costEmpty': 'Nothing has been counted yet, so there is nothing to cost.',
    ...
    'inv.packByPieceNoPrice': 'Priced by the piece, but no price has been entered.',
    'inv.purchasesTitle': 'Fill in what was bought?',
    'inv.purchasesMessage': { one: 'The orders recorded in {month} account for {n} product. What was ordered goes in as what you bought, replacing anything typed here by hand. Careful: ordered is not the same as delivered — what a supplier did not bring counts only if it was ticked as missing, so check anything you are unsure of. Every figure stays editable.', other: 'The orders recorded in {month} account for {n} products. What was ordered goes in as what you bought, replacing anything typed here by hand. Careful: ordered is not the same as delivered — what a supplier did not bring counts only if it was ticked as missing, so check anything you are unsure of. Every figure stays editable.' },
    'inv.purchasesOk': 'Fill them in',
    'inv.purchasesFilled': { one: '{n} product filled in from the orders.', other: '{n} products filled in from the orders.' },
    'inv.purchasesNone': 'No orders recorded in {month}.',
    'inv.purchasesFailed': 'Could not read the orders — write in what you bought by hand.',
    'inv.carryTitle': 'Carry last month’s counts forward?',
    'inv.carryMessage': 'The opening figures for this month become what was left at the end of {month}. Anything already typed here is overwritten.',
    ...
    'inv.closeMessageMissing': { one: '{n} product has not been counted, so {month} will have no answer for it. The month is closed as it stands and the next one opens with what is there today.', other: '{n} products have not been counted, so {month} will have no answer for them. The month is closed as it stands and the next one opens with what is there today.' },
    'inv.closeOk': 'Close the month',
    'inv.closed': 'Month closed.',
    'inv.closedAndOpened': 'Month closed. {month} is open, with what was left as its opening.',
    'inv.reopenMonth': 'Reopen the month',
    'inv.reopenTitle': 'Reopen this month?',
    'inv.reopenMessage': 'You will be able to correct its figures again. Note that the month after it does NOT change: its opening figures were copied when this one was closed, so correct them there too if they matter.',
    'inv.reopenOk': 'Reopen',
    'inv.notSavedYet': 'Not saved online yet. The count is safe on this phone and goes up on its own.',
    'inv.liveSyncInterrupted': 'Live updates interrupted — reopen the page to reconnect.',
    'help.stocktake': 'Once a month, count what is on the shelves. The app already knows what you had and what you bought, so it works out what you used.',
    'help.stocktakeEmpty': 'A box left empty means you have not counted that product yet — it is never read as zero, because a product nobody counted would otherwise look entirely used up.',
    ...
    'ui.endOfMonthCount': 'End-of-month count',
    ...
    'cat.netWeight': 'Net weight of one pack',
    'cat.shelfLife': 'Keeps for',
    'cat.days': 'days',
    'cat.labelFieldsNote': 'These two are printed on the label. Leave them empty if you do not know them — an empty box means «nobody has said», and the label simply leaves the line out.',
    'label.settings.full': 'What else goes on the label',
    'label.settings.fullNote': 'For food sold in your own shop the name and the ingredients with the allergens are enough. These are for food sold somewhere else.',
    'label.settings.showWeight': 'Net weight',
    'label.settings.showStorage': 'How to keep it',
    'label.settings.showBusiness': 'Who made it',
    'label.settings.storageText': 'How to keep it',
    'label.settings.storagePlaceholder': 'e.g. Keep refrigerated below 5°C',
    'label.settings.businessName': 'Business name',
    'label.settings.businessAddress': 'Address',
    'label.settings.businessNote': 'The law asks for a business that can be traced. A name with no address identifies nobody.',
    'label.settings.dateKind': 'Which date',
    'label.settings.dateKind.useBy': 'Use by',
    'label.settings.dateKind.bestBefore': 'Best before',
    'label.settings.dateKindNote': '«Use by» is about SAFETY — after that day the food must not be eaten. «Best before» is about quality: it is still safe, just no longer at its best. Choose the wrong one and you either throw away good food or keep unsafe food.',
    'label.settings.emptyBlock': 'Switched on, but nothing to print yet — fill in the box above or the label leaves the line out.',
    'label.print.viaAgent': 'Print',
    'label.print.queued': 'Sent to the shop computer — it prints it',
    'label.print.queueFailed': 'Could not send it — try again',
    'label.print.printerOffline': 'The shop computer is not answering, so nothing can be printed from here. Check it is switched on and that the printing program is running.',
  ...
  it: Object.freeze({
    ...
    // ── Magazzino — l'inventario di fine mese ───────────────────────
    'inv.monthOpen': 'Aperto',
    'inv.monthClosed': 'Chiuso',
    'inv.previousMonth': 'Il mese prima',
    'inv.nextMonth': 'Il mese dopo',
    'inv.counted': 'Contati',
    'inv.countedOf': '{counted} su {total}',
    'inv.emptyIsNotZero': 'Una casella lasciata vuota vuol dire «non ancora contato», mai zero.',
    'inv.monthClosedNote': 'Questo mese è chiuso: i suoi numeri non cambiano più.',
    'inv.searchProducts': 'Cerca un prodotto',
    'inv.stillToCount': 'Ancora da contare',
    'inv.nothingMatches': 'Nessun risultato.',
    'inv.noProductsYet': 'Ancora nessun prodotto. Arrivano da «Fornitori e ingredienti».',
    'inv.noCategory': 'Senza categoria',
    'inv.unnamedProduct': 'Prodotto senza nome',
    'inv.packsShort': 'conf.',
    'inv.notCountedYet': 'Non ancora contato',
    'inv.noOpeningYet': 'Manca la rimanenza iniziale',
    'inv.hadBoughtUsed': 'Avevi {had} · comprati {bought} · consumo {used}',
    'inv.countFor': 'Quanti ne restano di {name}',
    'inv.openProduct': 'Apri {name}',
    'inv.usedThisMonth': 'Consumo del mese',
    'inv.answerNeedsCount': 'Conta quello che è rimasto e il numero viene da sé.',
    'inv.answerNeedsOpening': 'Scrivi quanti ce n’erano all’inizio del mese e il numero viene da sé.',
    'inv.hadBoughtLeft': 'Avevi {had} · comprati {bought} · rimasti {left}',
    'inv.moreThanPossible': 'Qui ce n’è più di quanti ne avevi all’inizio più tutti quelli che hai comprato. Uno dei tre numeri è sbagliato.',
    'inv.openingCount': 'Quanti ce n’erano all’inizio del mese',
    'inv.openingHint': 'Si scrive una volta sola: dal mese prossimo l’app la porta avanti da quello che è rimasto.',
    'inv.purchasedCount': 'Quanti ne hai comprati nel mese',
    'inv.purchasedHint': 'Se la lasci vuota, conta come nessun acquisto.',
    'inv.closingCount': 'Quanti ne hai adesso',
    'inv.closingHint': 'Mezza confezione si scrive 0,5.',
    'inv.onePackIs': 'Una confezione è {pack}.',
    'inv.carryShort': 'Porta avanti',
    'inv.purchasesShort': 'Dagli ordini',
    'inv.seeCost': 'Quanto è costato',
    'inv.costTitle': 'Il costo del mese',
    'inv.costThisMonth': 'Valore di quello che hai consumato',
    'inv.costBasis': { one: 'Calcolato su {counted} prodotto che hai contato.', other: 'Calcolato su {counted} prodotti che hai contato.' },
    'inv.costBasisPartial': { one: 'Calcolato su {counted} contati, di cui {n} senza valore.', other: 'Calcolato su {counted} contati, di cui {n} senza valore.' },
    'inv.costEmpty': 'Non hai ancora contato niente, quindi non c’è niente da valorizzare.',
    ...
    'inv.packByPieceNoPrice': 'Prezzo a pezzo, ma il prezzo non è stato inserito.',
    'inv.purchasesTitle': 'Compilare quello che hai comprato?',
    'inv.purchasesMessage': { one: 'Gli ordini registrati a {month} riguardano {n} prodotto. Le quantità ordinate entrano come acquisti e sostituiscono quello che hai scritto a mano qui. Attenzione: ordinato non vuol dire consegnato — quello che un fornitore non ha portato conta solo se l’hai segnato come mancante, quindi controlla quelli di cui non sei sicuro. Ogni numero resta modificabile.', other: 'Gli ordini registrati a {month} riguardano {n} prodotti. Le quantità ordinate entrano come acquisti e sostituiscono quello che hai scritto a mano qui. Attenzione: ordinato non vuol dire consegnato — quello che un fornitore non ha portato conta solo se l’hai segnato come mancante, quindi controlla quelli di cui non sei sicuro. Ogni numero resta modificabile.' },
    'inv.purchasesOk': 'Compila',
    'inv.purchasesFilled': { one: '{n} prodotto compilato dagli ordini.', other: '{n} prodotti compilati dagli ordini.' },
    'inv.purchasesNone': 'Per {month} non risulta nessun ordine.',
    'inv.purchasesFailed': 'Non riesco a leggere gli ordini — scrivi a mano quello che hai comprato.',
    'inv.carryTitle': 'Portare avanti le rimanenze?',
    'inv.carryMessage': 'Le rimanenze iniziali di questo mese diventano quelle rimaste alla fine di {month}. Quello che hai già scritto qui viene sovrascritto.',
    ...
    'inv.closeMessageMissing': { one: '{n} prodotto non è stato contato e per {month} resterà senza risposta. Il mese viene chiuso così com’è e quello dopo si apre con quello che c’è oggi.', other: '{n} prodotti non sono stati contati e per {month} resteranno senza risposta. Il mese viene chiuso così com’è e quello dopo si apre con quello che c’è oggi.' },
    'inv.closeOk': 'Chiudi il mese',
    'inv.closed': 'Mese chiuso.',
    'inv.closedAndOpened': 'Mese chiuso. {month} è aperto, con le rimanenze già portate avanti.',
    'inv.reopenMonth': 'Riapri il mese',
    'inv.reopenTitle': 'Riaprire questo mese?',
    'inv.reopenMessage': 'Potrai correggere di nuovo i suoi numeri. Attenzione: il mese successivo NON cambia — le sue rimanenze iniziali sono state copiate quando questo è stato chiuso, quindi se contano vanno corrette anche lì.',
    'inv.reopenOk': 'Riapri',
    'inv.notSavedYet': 'Non ancora salvato online: il conteggio è al sicuro su questo telefono e sale da solo.',
    'inv.liveSyncInterrupted': 'Aggiornamenti in tempo reale interrotti — riapri la pagina per ricollegarti.',
    'help.stocktake': 'Una volta al mese conta quello che c’è sugli scaffali. Quanto avevi e quanto hai comprato l’app li sa già, quindi calcola da sé quanto hai consumato.',
    'help.stocktakeEmpty': 'Una casella lasciata vuota vuol dire che quel prodotto non l’hai ancora contato — non viene mai letta come zero, perché un prodotto che nessuno ha contato risulterebbe consumato tutto.',
    'help.stocktakeClose': 'Chiudere il mese congela i suoi numeri e apre quello dopo con quello che è rimasto sugli scaffali, così le rimanenze iniziali le scrivi una volta sola.',
    ...
    'ui.endOfMonthCount': 'Inventario di fine mese',
    ...
    'cat.netWeight': 'Peso netto di una confezione',
    'cat.shelfLife': 'Si conserva per',
    'cat.days': 'giorni',
    'cat.labelFieldsNote': 'Questi due si stampano sull’etichetta. Lasciali vuoti se non li sai — una casella vuota vuol dire «nessuno l’ha detto», e l’etichetta semplicemente non stampa quella riga.',
    'label.settings.full': 'Cos’altro va sull’etichetta',
    'label.settings.fullNote': 'Per il cibo venduto nel tuo negozio bastano il nome e gli ingredienti con gli allergeni. Questi servono per il cibo venduto altrove.',
    'label.settings.showWeight': 'Peso netto',
    'label.settings.showStorage': 'Come si conserva',
    'label.settings.showBusiness': 'Chi l’ha prodotto',
    'label.settings.storageText': 'Come si conserva',
    'label.settings.storagePlaceholder': 'es. Conservare in frigorifero sotto i 5°C',
    'label.settings.businessName': 'Nome dell’attività',
    'label.settings.businessAddress': 'Indirizzo',
    'label.settings.businessNote': 'La legge chiede un’attività rintracciabile. Un nome senza indirizzo non identifica nessuno.',
    'label.settings.dateKind': 'Quale data',
    'label.settings.dateKind.useBy': 'Da consumarsi entro',
    'label.settings.dateKind.bestBefore': 'Da consumarsi preferibilmente entro',
    'label.settings.dateKindNote': '«Da consumarsi entro» riguarda la SICUREZZA: dopo quel giorno il cibo non si mangia. «Preferibilmente entro» riguarda la qualità: è ancora sicuro, solo non al meglio. Sbagliare vuol dire buttare cibo buono, oppure tenere cibo non sicuro.',
    'label.settings.emptyBlock': 'Acceso, ma non c’è ancora niente da stampare — riempi la casella qui sopra, altrimenti l’etichetta salta la riga.',
    'label.print.viaAgent': 'Stampa',
    'label.print.queued': 'Mandata al computer del negozio — la stampa lui',
    'label.print.queueFailed': 'Non è riuscita a partire — riprova',
    'label.print.printerOffline': 'Il computer del negozio non risponde, quindi da qui non si può stampare. Controlla che sia acceso e che il programma di stampa sia in funzione.',
